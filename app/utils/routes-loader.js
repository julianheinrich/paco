...
// TODO: pass arguments via loader queries?
const config = require('../config.js');
const configEnvironment = global.CONFIG_ENV ? global.CONFIG_ENV : 'development';
const baseURL = config[configEnvironment].baseURL;
