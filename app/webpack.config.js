...
const baseURL = pacoConfig[configEnvironment].baseURL;
console.log('config env is ' + configEnvironment);

// Webpack configuration (main.js => public/dist/main.{hash}.js)
// http://webpack.github.io/docs/configuration.html
const config = {

  // This is required for npm-linked modules to find their dependencies
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      ...
      __DEV__: isDebug,
      CONFIG: JSON.stringify(pacoConfig[configEnvironment]),
    }),
    ...
    loaders: [
      {
        ...
        include: [
          ...
          path.resolve(__dirname, './node_modules/react-parallel-coordinates'),
        ],
